USE [master]
GO
/****** Object:  Database [Prueba_11]    Script Date: 07/05/2025 05:27:19 p. m. ******/
CREATE DATABASE [Prueba_11]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Prueba_11', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Prueba_11.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Prueba_11_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Prueba_11_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [Prueba_11] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Prueba_11].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Prueba_11] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Prueba_11] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Prueba_11] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Prueba_11] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Prueba_11] SET ARITHABORT OFF 
GO
ALTER DATABASE [Prueba_11] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [Prueba_11] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Prueba_11] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Prueba_11] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Prueba_11] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Prueba_11] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Prueba_11] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Prueba_11] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Prueba_11] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Prueba_11] SET  ENABLE_BROKER 
GO
ALTER DATABASE [Prueba_11] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Prueba_11] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Prueba_11] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Prueba_11] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Prueba_11] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Prueba_11] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Prueba_11] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Prueba_11] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [Prueba_11] SET  MULTI_USER 
GO
ALTER DATABASE [Prueba_11] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Prueba_11] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Prueba_11] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Prueba_11] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Prueba_11] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Prueba_11] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [Prueba_11] SET QUERY_STORE = OFF
GO
USE [Prueba_11]
GO
/****** Object:  Table [dbo].[credenciales]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[departamento_puesto]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[departamentos]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[incidencias]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[jefes]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[motivos]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[puestos]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[roles]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[usuario_rol]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[usuarios]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vacaciones]    Script Date: 07/05/2025 05:27:19 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[incidencias] ([idIncidencia], [numNomina_solicitante], [nombre_solicitante], [apellido_paterno], [apellido_materno], [fecha_solicitud], [puesto], [departamento], [dias_vacaciones], [motivo], [fecha_inicio], [fecha_fin], [num_dias], [observaciones], [estatus], [aprobado_por_supervisor], [fecha_aprobacion_supervisor], [aprobado_por_gerente], [fecha_aprobacion_gerente], [comentarios_supervisor], [comentarios_gerente], [jefe_directo], [gerente_responsable]) VALUES (1, 1035, N'Alan de Jesús', N'Valenciano', N'Llamas', CAST(N'2025-04-24' AS Date), N'Auxiliar', N'Sistemas', 7, N'vacaciones', CAST(N'2025-04-23' AS Date), CAST(N'2025-04-24' AS Date), 2, N'12345', N'Aprobada', 712, CAST(N'2025-04-24T10:09:31.477' AS DateTime), 265, CAST(N'2025-04-24T11:08:05.193' AS DateTime), N'', N'', 712, 265)
GO
INSERT [dbo].[incidencias] ([idIncidencia], [numNomina_solicitante], [nombre_solicitante], [apellido_paterno], [apellido_materno], [fecha_solicitud], [puesto], [departamento], [dias_vacaciones], [motivo], [fecha_inicio], [fecha_fin], [num_dias], [observaciones], [estatus], [aprobado_por_supervisor], [fecha_aprobacion_supervisor], [aprobado_por_gerente], [fecha_aprobacion_gerente], [comentarios_supervisor], [comentarios_gerente], [jefe_directo], [gerente_responsable]) VALUES (2, 1035, N'Alan de Jesús', N'Valenciano', N'Llamas', CAST(N'2025-04-24' AS Date), N'Auxiliar', N'Sistemas', 7, N'vacaciones', CAST(N'2025-04-25' AS Date), CAST(N'2025-04-28' AS Date), 4, N'123456', N'Aprobada', 712, CAST(N'2025-04-24T14:07:25.190' AS DateTime), 265, CAST(N'2025-04-24T14:07:40.357' AS DateTime), N'', N'', 712, 265)
GO
INSERT [dbo].[incidencias] ([idIncidencia], [numNomina_solicitante], [nombre_solicitante], [apellido_paterno], [apellido_materno], [fecha_solicitud], [puesto], [departamento], [dias_vacaciones], [motivo], [fecha_inicio], [fecha_fin], [num_dias], [observaciones], [estatus], [aprobado_por_supervisor], [fecha_aprobacion_supervisor], [aprobado_por_gerente], [fecha_aprobacion_gerente], [comentarios_supervisor], [comentarios_gerente], [jefe_directo], [gerente_responsable]) VALUES (3, 1035, N'Alan de Jesús', N'Valenciano', N'Llamas', CAST(N'2025-04-24' AS Date), N'Auxiliar', N'Sistemas', 7, N'vacaciones', CAST(N'2025-04-25' AS Date), CAST(N'2025-04-28' AS Date), 4, N'123456', N'Aprobada', 712, CAST(N'2025-04-24T15:25:13.987' AS DateTime), 265, CAST(N'2025-04-24T15:25:29.980' AS DateTime), N'', N'', 712, 265)
GO
...
GO
INSERT [dbo].[usuarios] ([numNomina], [nombre], [apellidoPaterno], [apellidoMaterno], [idDepartamento], [idPuesto], [diasVacaciones], [correo_electronico], [jefe_directo]) VALUES (712, N'Jesús Abraham', N'Palafox', N'Romo', 5, 16, 7, N'soporte@tohken.mx', 265)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__credenci__F3DBC5725A498079]    Script Date: 07/05/2025 05:27:19 p. m. ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__departam__97ABAFF50F27141E]    Script Date: 07/05/2025 05:27:19 p. m. ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__puestos__0CBEA40B6E1EC6F8]    Script Date: 07/05/2025 05:27:19 p. m. ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [uq_nombrePuesto]    Script Date: 07/05/2025 05:27:19 p. m. ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__roles__2787B00C3BC78D21]    Script Date: 07/05/2025 05:27:19 p. m. ******/
...
USE [master]
GO
ALTER DATABASE [Prueba_11] SET  READ_WRITE 
GO
